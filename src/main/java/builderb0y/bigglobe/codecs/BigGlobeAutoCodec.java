...
public class BigGlobeAutoCodec {
	...
	public static final RegistryCoders<StatusEffect>                          STATUS_EFFECT_REGISTRY_CODERS = new RegistryCoders<>(ReifiedType.from(StatusEffect                          .class), Registries.STATUS_EFFECT);
	#endif
